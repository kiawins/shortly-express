...
describe('', function() {
  ...
  describe('Link creation:', function(){
    ...
    console.log('request session: ', requestWithSession);
    beforeEach(function(done){      // create a user that we can then log-in with
      var phillip = new User({
          'username': 'Phillip',
          'password': 'Phillip'
      });
      console.log('new user made ', phillip);

      phillip.save().then(function(){
        ...
        console.log('about to request new session ', requestWithSession);
    ...
    describe('With previously saved urls:', function(){
      ...
      it('Returns all of the links to display on the links page', function(done) {
        ...
        requestWithSession(options, function(error, res, body) {
          ...
          console.log('REQUIRES: ' , '"code":"' + link.get('code') + '"');
